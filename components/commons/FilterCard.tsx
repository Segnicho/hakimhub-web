...
const FilterCard: React.FC = () => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg w-1/4 justify-end text-primary font-bold p-8 text-lg">
      <h3 className="text-primary-text text-xl font-bold mb-8">Filter</h3>
