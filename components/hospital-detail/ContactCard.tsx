...
const ContactCard: React.FC<ContactProps> = ({ website, phoneNumber }) => {
  return (
    <div className="sm:w-[400px] sm:mx-28 lg:w-[300px] lg:mx-16 xl:w-[350px] xl:mx-16 2xl:w-[400px] 2xl:mx-16 w-sm flex flex-col bg-white rounded-lg drop-shadow shadow-xl p-4 mx-10 my-4">
      ...
      <div className="overflow-y-auto gap-4">
        ...
        <div className="flex items-center gap-5 max-w-sm bg-white rounded-lg drop-shadow-md my-4">
          <MdPhone className="h-4 w-12 text-primary bg-white rounded-full" />
     ...
     {(website && 
      ...
      <div className="flex items-center gap-5 max-w-sm bg-white rounded-lg drop-shadow-md">
        <TbBrandWebflow className="h-4 w-12 text-primary bg-white rounded-full" />
