...
const DoctorCard: React.FC<Props> = ({ doctor }) => {
  ...
  return (
    (<Link href={`/doctors/${doctor.id}`} className=''>
      <div className='flex flex-col justify-start items-center  mx-2 h-[150px] bg-white rounded-[12px] drop-shadow-xl border-2 border-grey-200 mb-2 mt-14 relative text-center lg:min-w-[250px]'>
        ...
        <div className="text-sm font-bold mx-8 mt-12 xl:text-lg 2xl:text-xl">
          <h3 >{doctor?.fullName}</h3></div>
